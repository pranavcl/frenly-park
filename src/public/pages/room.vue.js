const MusicApp = {
	...
	computed: {
		...
		mode() {
			if (!this.isLooping && !this.isShuffled) return "🔁";
			else if (this.isLooping) return "🔂";
			else if (this.isShuffled) return "🔀";
		},
	},
	...
	methods: {
		...
		checkState() {
			if (this.$refs.player.paused) this.isPlaying = false;
		...
		manageEnding() {
			if (!this.isLooping) this.changeSong("next", this.isShuffled);
		},
		changeMode() {
			if (!this.isLooping && !this.isShuffled) this.isLooping = true;
			else if (this.isLooping) {
				this.isLooping = false;
				this.isShuffled = true;
			} else if (this.isShuffled) this.isShuffled = false;
